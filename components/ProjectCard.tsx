...
const ProjectCard = ({ project, priority = false }: { project: Project; priority?: boolean }) => {
  return (
    <article className="flex flex-col sm:flex-row gap-4 w-full p-4 rounded-lg border border-border bg-surface hover:bg-surface-hover transition-colors duration-200">
      {project.img && (
